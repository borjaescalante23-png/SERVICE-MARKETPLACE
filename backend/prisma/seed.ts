...
async function main() {
  ...
  const professionals = [
    ...
    {
      email: 'elena.moreno@test.com',
      password: 'Pro1234!',
      firstName: 'Elena',
      lastName: 'Moreno',
      bio: 'Profesora certificada de Yoga y Pilates con más de 8 años de experiencia. Especializada en yoga terapéutico, hatha, vinyasa y pilates mat. Clases personalizadas para todos los niveles.',
      city: 'Barcelona',
      level: 'PRO',
      avgRating: 4.9,
      totalReviews: 27,
      ...
      acceptanceRate: 0.95,
      services: [
        { name: 'Clase de Yoga a Domicilio', category: 'YOGA', price: 55, duration: 60, description: 'Clase personalizada de yoga adaptada a tu nivel. Incluye material (esterilla y bloques).' },
        { name: 'Sesión de Pilates Mat', category: 'PILATES', price: 55, duration: 60, description: 'Pilates en suelo para mejorar la postura, la fuerza del core y la flexibilidad.' },
        { name: 'Yoga + Meditación (90 min)', category: 'YOGA', price: 75, duration: 90, description: 'Sesión completa de yoga con cierre de meditación guiada para bienestar integral.' },
      ],
      availability: [1,2,3,4,5,6],
      reviewCategory: 'PERSONAL_TRAINER',
    },
    {
      email: 'raul.gomez@test.com',
      password: 'Pro1234!',
      firstName: 'Raúl',
      lastName: 'Gómez',
      bio: 'Pintor profesional con 14 años de experiencia en pintura interior y exterior. Especialista en acabados decorativos, pintura de muebles y reformas completas. Presupuesto sin compromiso.',
      city: 'Barcelona',
      level: 'VERIFIED',
      avgRating: 4.6,
      totalReviews: 21,
      ...
      acceptanceRate: 0.89,
      services: [
        { name: 'Pintura de Habitación', category: 'PAINTING', price: 120, duration: 240, description: 'Pintura completa de una habitación, incluyendo preparación de paredes y materiales.' },
        { name: 'Pintura de Salón / Comedor', category: 'PAINTING', price: 200, duration: 360, description: 'Pintura de salón con dos manos de acabado. Protección de muebles y limpieza incluida.' },
        { name: 'Acabados Decorativos', category: 'PAINTING', price: 180, duration: 300, description: 'Técnicas decorativas: estuco veneciano, microcemento, efecto tiza y otras texturas.' },
      ],
      availability: [1,2,3,4,5,6],
      reviewCategory: 'HANDYMAN',
    },
    {
      email: 'nuria.camps@test.com',
      password: 'Pro1234!',
      firstName: 'Nuria',
      lastName: 'Camps',
      bio: 'Dietista-nutricionista y fisioterapeuta titulada. Combino la nutrición clínica con la fisioterapia para ofrecer un enfoque integral del bienestar. Más de 7 años ayudando a mis pacientes a alcanzar sus objetivos.',
      city: 'Barcelona',
      level: 'ELITE',
      avgRating: 4.9,
      totalReviews: 33,
      ...
      acceptanceRate: 0.97,
      services: [
        { name: 'Consulta de Nutrición', category: 'NUTRITION', price: 70, duration: 60, description: 'Evaluación nutricional personalizada y plan de alimentación adaptado a tus objetivos.' },
        { name: 'Sesión de Fisioterapia', category: 'PHYSIOTHERAPY', price: 75, duration: 60, description: 'Tratamiento fisioterapéutico domiciliario para lesiones, contracturas y rehabilitación.' },
        { name: 'Pack Nutrición + Fisio (x4)', category: 'NUTRITION', price: 250, duration: 60, description: 'Pack mensual con 2 consultas de nutrición y 2 sesiones de fisioterapia para un abordaje completo.' },
      ],
      availability: [1,2,3,4,5],
      reviewCategory: 'PERSONAL_TRAINER',
    },
    {
      email: 'marc.ribas@test.com',
      password: 'Pro1234!',
      firstName: 'Marc',
      lastName: 'Ribas',
      bio: 'Músico y pedagogo con estudios superiores en guitarra clásica y teoría musical. Imparto clases de guitarra, piano y lenguaje musical a domicilio para todas las edades y niveles.',
      city: 'Barcelona',
      level: 'PRO',
      avgRating: 4.8,
      totalReviews: 24,
      ...
      acceptanceRate: 0.93,
      services: [
        { name: 'Clases de Guitarra', category: 'MUSIC', price: 45, duration: 60, description: 'Clases de guitarra clásica, acústica o eléctrica adaptadas a tu nivel. Desde principiante.' },
        { name: 'Clases de Piano', category: 'MUSIC', price: 50, duration: 60, description: 'Clases de piano para todos los niveles, con método personalizado y repertorio variado.' },
        { name: 'Lenguaje Musical y Solfeo', category: 'MUSIC', price: 40, duration: 60, description: 'Fundamentos de teoría musical, solfeo y armonía para estudiantes y músicos.' },
      ],
      availability: [1,2,3,4,5,6],
      reviewCategory: 'TUTORING',
    },
    {
      email: 'ingrid.sola@test.com',
      password: 'Pro1234!',
      firstName: 'Ingrid',
      lastName: 'Sola',
      bio: 'Fotógrafa profesional especializada en fotografía de familia, eventos sociales y retratos corporativos. Entrega de fotos editadas en 48h. Estilo natural, luminoso y elegante.',
      city: 'Barcelona',
      level: 'PRO',
      avgRating: 4.9,
      totalReviews: 28,
      ...
      acceptanceRate: 0.94,
      services: [
        { name: 'Sesión de Fotos Familiar', category: 'PHOTOGRAPHY', price: 150, duration: 120, description: 'Reportaje fotográfico familiar en exteriores o domicilio. 30 fotos editadas incluidas.' },
        { name: 'Retrato Corporativo / Profesional', category: 'PHOTOGRAPHY', price: 100, duration: 90, description: 'Sesión de retratos profesionales para LinkedIn, webs y dossieres corporativos.' },
        { name: 'Cobertura de Evento Social', category: 'PHOTOGRAPHY', price: 300, duration: 240, description: 'Cobertura fotográfica de cumpleaños, comuniones, graduaciones y eventos privados.' },
      ],
      availability: [1,2,3,4,5,6],
      reviewCategory: 'CHEF',
    },
    {
      email: 'victor.andreu@test.com',
      password: 'Pro1234!',
      firstName: 'Víctor',
      lastName: 'Andreu',
      bio: 'Auxiliar de geriatría titulado con 10 años de experiencia en cuidado de personas mayores a domicilio. Especializado en Alzheimer, movilidad reducida y acompañamiento terapéutico.',
      city: 'Barcelona',
      level: 'PRO',
      avgRating: 4.8,
      totalReviews: 22,
      ...
      acceptanceRate: 0.96,
      services: [
        { name: 'Cuidado de Mayores (Jornada)', category: 'ELDERLY_CARE', price: 90, duration: 480, description: 'Atención integral durante la jornada: higiene, alimentación, medicación y compañía.' },
        { name: 'Acompañamiento y Paseos', category: 'ELDERLY_CARE', price: 35, duration: 120, description: 'Acompañamiento a médicos, paseos y actividades de estimulación cognitiva.' },
        { name: 'Cuidados Nocturnos', category: 'ELDERLY_CARE', price: 110, duration: 480, description: 'Asistencia nocturna para personas con dependencia severa o problemas de sueño.' },
      ],
      availability: [1,2,3,4,5,6,0],
      reviewCategory: 'ELDERCARE',
    },
  ];
