...
const reviewPools: Record<string, string[]> = {
  ...
  CHILDCARE: [
    'Los niños estuvieron encantados con ella. Muy responsable y cariñosa.',
    'Tranquilizadora y profesional. Mis hijos quedaron muy bien atendidos.',
    'Excelente cuidadora. Hizo actividades con los niños y los mantuvo entretenidos todo el día.',
    'Muy de fiar. Los niños la quieren mucho y yo me fui tranquila al trabajo.',
    'Gran profesional. Tiene mucha experiencia y los niños se sienten seguros con ella.',
    'Lo recomiendo a todas las familias. Puntual, responsable y muy cariñosa.',
    'Mis hijos me pidieron que la volviera a contratar. Es fantástica con los niños.',
  ],
  CHEF: [
...
async function main() {
  ...
  const professionals = [
    ...
    {
      email: 'elena.costa@test.com',
      password: 'Pro1234!',
      firstName: 'Elena',
      lastName: 'Costa',
      bio: 'Educadora infantil con 7 años de experiencia en cuidado y educación de niños de 0 a 12 años. Domino actividades creativas, inglés básico y primeros auxilios pediátricos.',
      city: 'Barcelona',
      level: 'PRO',
      avgRating: 4.8,
      totalReviews: 24,
      ...
      acceptanceRate: 0.93,
      services: [
        { name: 'Cuidado a Domicilio (por horas)', category: 'CHILDCARE', price: 15, duration: 60, description: 'Cuidado y entretenimiento de niños en casa. Mínimo 2 horas. Actividades educativas incluidas.' },
        { name: 'Cuidado Nocturno', category: 'CHILDCARE', price: 80, duration: 480, description: 'Cuidado nocturno de niños de 0-12 años. Rutinas de sueño, baño y cena incluidos.' },
        { name: 'Apoyo Escolar y Juego', category: 'CHILDCARE', price: 20, duration: 90, description: 'Acompañamiento en deberes escolares y actividades lúdicas. Para niños de 4 a 12 años.' },
      ],
      availability: [1,2,3,4,5,6],
      reviewCategory: 'CHILDCARE',
    },
    {
